...
//set marked variable
        $data['marked'] = false;
        if (isset($data['answered_test_row']->submitted) && $data['answered_test_row']->marked == 1) {
            $data['marked'] = true;
        }
//get student information
        ...
        <div style="font-family: roboto;font-size: 18px;max-width: 1000px;margin: auto">
            <table>
                <tr>
                    <td colspan="4" style="font-size: 20px;text-align: center;">Test:
                ...
                <td style="text-align: center;" colspan="4"><b>Text description:</b><br><?=esc($row->description)?></td>
