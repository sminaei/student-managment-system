...
<form method="post" enctype="multipart/form-data">
    ...
    <div class="input-group mb-3 pt-3">
        ...
        <input type="text" name="comment" value="<?=get_var('comment',$question->comment)?>" class="form-control"  placeholder="comment(optional)">
       </div>
    ...
    <div class="input-group mb-3 ">
        ...
        <input type="text"  value="<?=get_var('correct_answer',$question->correct_answer)?>" name="correct_answer" class="form-control" id="inputGroupFile01" placeholder="Enter the correct answer">
    </div>
    <?php endif;?>
        ...
        <div class="card" style="">
            ...
            <ul class="list-group list-group-flush choice-list">
                    ...
                    foreach ($_POST as $key => $value){
                        if (strstr($key, 'choice')){
                            ...
                            <li class="list-group-item">
                                <?=$letters[$num]?> : <input type="text" class="form-control" value="<?=$value?>" name="<?=$key?>" placeholder="type your answer">
                ...
                <?php foreach ($choices as $letter => $answer):?>
                    <li class="list-group-item">
                        A: <input type="text" class="form-control" name="choice<?=$num?>" placeholder="type your answer" value="<?=$answer?>">
                    ...
                    <?php endforeach;?>
                    <li class="list-group-item">
                        B: <input type="text" class="form-control" name="choice2" placeholder="type your answer">  item
