...
<?php if (isset($questions) && is_array($questions)):?>
            ...
            <div class="card-body">
                ...
                <?php if ($question->question_type != 'multiple'):?>
                    <?php if (!$submitted):?>
                        ...
                        <input type="text"  value="<?=$myanswer?>" class="form-control" name="<?=$question->id?>" placeholder="Type your answer">
                    <?php else:?>
    ...
    <?php if (!$submitted):?>
        <center>
            <small>Click to save answers before moving to another page to save your answer</small><br>
            <button class="btn btn-primary">Save Answers</button></center>
