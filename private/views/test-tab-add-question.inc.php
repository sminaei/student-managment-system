...
<form method="post" enctype="multipart/form-data">
    ...
    <?php if (isset($_GET['type']) && $_GET['type'] == "objective"): ?>
        <div class="input-group mb-3 ">
            ...
            <input type="text"  value="<?=get_var('correct_answer')?>" name="correct_answer" class="form-control" id="inputGroupFile01" placeholder="Enter the correct answer">
        </div>
    <?php endif;?>
    ...
    <?php if (isset($_GET['type']) && $_GET['type'] == "multiple"):?>
        <div class="card" style="">
            ...
            <ul class="list-group list-group-flush choice-list">
                ...
                <?php else:?>
                    <li class="list-group-item">
                        A: <input type="text" class="form-control" name="choice0" placeholder="type your answer">
                        <label style="cursor: pointer;"><input type="radio" value="A" name="correct_answer">Correct answer</label>
                    </li>
                    <li class="list-group-item">
                        B: <input type="text" class="form-control" name="choice1" placeholder="type your answer">
