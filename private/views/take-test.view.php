    ...
    <?php if($row && !($row->disabled && Auth::access('student'))): ?>
        ...
        <div class="row">
            ...
            <center class="row">
                ...
                <h5 class="col">Student:<?=$student_row->firstname?> <?=$student_row->lastname?></h5></center>
            ...
            <table class="table table-hover table-striped table-bordered">
                ...
                <tr><td><b>Class:</b><?=$row->class->class?></td>
                    <td colspan="5"><b>Text description:</b><br><?=esc($row->description)?></td>
                </tr>
            </table>
        </div>
