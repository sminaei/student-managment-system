...
<?php if (isset($questions) && is_array($questions)):?>
    ...
    <?php if (!$marked):?>
        <center>
            <small>Click to save marks before moving to another page to saver</small><br>
            <button class="btn btn-primary">Save Marks</button></center>
...
<script>
    ...
    function unsubmit_test(e){
        if (!confirm("Are you sure you want to remove this test from submission list test?")){
            e.preventDefault();
            return;
        }
    ...
    function auto_mark(e){
        if (!confirm("Are you sure you want to auto mark this test ?")){
            e.preventDefault();
            return;
        }
    ...
    function set_test_as_marked(e){
        ...
        if (percent < 100){
            e.preventDefault();
            alert("You have only marked "+percent+"% of the question.You can only set a test as marked after marking all question");
            return;
        }
